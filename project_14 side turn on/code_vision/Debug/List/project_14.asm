...
;	a -> R16
	...
	ORI  R30,0x40
	MOV  R16,R30
; 0000 0074 for(i=0; i<8; i++)lcd_write_byte(a++,*pc++);
	LDI  R17,LOW(0)
_0x4:
	CPI  R17,8
	BRSH _0x5
...
; 0000 007D // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 007E DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(15)
	OUT  0x1A,R30
; 0000 007F // State: Bit7=T Bit6=P Bit5=P Bit4=P Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0080 PORTA=(0<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(112)
	OUT  0x1B,R30
; 0000 0081 
...
_0xD:
	...
	BRGE _0xE
; 0000 00FD           {
; 0000 00FE            lcd_gotoxy(k,0);
	RCALL SUBOPT_0x0
; 0000 00FF            lcd_putchar(i);
; 0000 0100            lcd_gotoxy(k,1);
; 0000 0101            lcd_putchar(i);
; 0000 0102            lcd_gotoxy(j,0);
; 0000 0103            lcd_putchar(d);
; 0000 0104            lcd_gotoxy(j,1);
; 0000 0105            lcd_putchar(d);
; 0000 0106            delay_ms(25);
; 0000 0107            d--;
	SBIW R30,1
	MOVW R10,R30
; 0000 0108           }
...
_0x13:
	...
	BRGE _0x14
; 0000 0111          {
; 0000 0112            lcd_gotoxy(k,0);
	RCALL SUBOPT_0x0
; 0000 0113            lcd_putchar(i);
; 0000 0114            lcd_gotoxy(k,1);
; 0000 0115            lcd_putchar(i);
; 0000 0116            lcd_gotoxy(j,0);
; 0000 0117            lcd_putchar(d);
; 0000 0118            lcd_gotoxy(j,1);
; 0000 0119            lcd_putchar(d);
