...
_0x10:
	...
	BRLT _0x11
; 0000 00FC         {
; 0000 00FD          lcd_gotoxy(i,k);
	RCALL SUBOPT_0x0
; 0000 00FE          lcd_putchar(j);
; 0000 00FF 
; 0000 0100         }
	MOVW R30,R4
	ADIW R30,1
...
_0x19:
	...
	BRLT _0x1A
; 0000 0109         {
; 0000 010A          lcd_gotoxy(i,k);
	RCALL SUBOPT_0x0
; 0000 010B          lcd_putchar(j);
; 0000 010C 
; 0000 010D         }
	MOVW R30,R4
	SBIW R30,1
