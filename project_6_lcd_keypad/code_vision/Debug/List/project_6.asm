...
; 0000 002B // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 002C DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(15)
	OUT  0x17,R30
; 0000 002D // State: Bit7=T Bit6=P Bit5=P Bit4=P Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 002E PORTB=(0<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(112)
	OUT  0x18,R30
; 0000 002F 
...
; 0000 009C            PORTB.3=1;
	SBI  0x18,3
; 0000 009D            if(PINB.4==0 && PINB.5==1 && PINB.6==1)
	SBIC 0x16,4
	RJMP _0xF
	SBIS 0x16,5
	RJMP _0xF
...
; 0000 009F             lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00A0             lcd_putsf("1");
	__POINTW2FN _0x0,0
	RCALL SUBOPT_0x1
; 0000 00A1             delay_ms(50);
; 0000 00A2            }
; 0000 00A3             if(PINB.4==1 && PINB.5==0 && PINB.6==1)
_0xE:
	SBIS 0x16,4
	RJMP _0x12
	SBIC 0x16,5
...
; 0000 00A5             lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00A6             lcd_putsf("2");
	__POINTW2FN _0x0,2
	RCALL SUBOPT_0x1
; 0000 00A7             delay_ms(50);
; 0000 00A8            }
; 0000 00A9             if(PINB.4==1 && PINB.5==1 && PINB.6==0)
_0x11:
	SBIS 0x16,4
	RJMP _0x15
	SBIS 0x16,5
...
; 0000 00B4            PORTB.3=1;
	SBI  0x18,3
; 0000 00B5             if(PINB.4==0 && PINB.5==1 && PINB.6==1)
	SBIC 0x16,4
	RJMP _0x20
	SBIS 0x16,5
	RJMP _0x20
...
; 0000 00B7             lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00B8             lcd_putsf("4");
	__POINTW2FN _0x0,6
	RCALL SUBOPT_0x1
; 0000 00B9             delay_ms(50);
; 0000 00BA            }
; 0000 00BB             if(PINB.4==1 && PINB.5==0 && PINB.6==1)
_0x1F:
	SBIS 0x16,4
	RJMP _0x23
	SBIC 0x16,5
...
; 0000 00BD             lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00BE             lcd_putsf("5");
	__POINTW2FN _0x0,8
	RCALL SUBOPT_0x1
; 0000 00BF             delay_ms(50);
; 0000 00C0            }
; 0000 00C1             if(PINB.4==1 && PINB.5==1 && PINB.6==0)
_0x22:
	SBIS 0x16,4
	RJMP _0x26
	SBIS 0x16,5
...
; 0000 00CC            PORTB.3=1;
	SBI  0x18,3
; 0000 00CD             if(PINB.4==0 && PINB.5==1 && PINB.6==1)
	SBIC 0x16,4
	RJMP _0x31
	SBIS 0x16,5
	RJMP _0x31
...
; 0000 00CF             lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00D0             lcd_putsf("7");
	__POINTW2FN _0x0,12
	RCALL SUBOPT_0x1
; 0000 00D1             delay_ms(50);
; 0000 00D2            }
; 0000 00D3             if(PINB.4==1 && PINB.5==0 && PINB.6==1)
_0x30:
	SBIS 0x16,4
	RJMP _0x34
	SBIC 0x16,5
...
; 0000 00D5             lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00D6             lcd_putsf("8");
	__POINTW2FN _0x0,14
	RCALL SUBOPT_0x1
; 0000 00D7             delay_ms(50);
; 0000 00D8            }
; 0000 00D9             if(PINB.4==1 && PINB.5==1 && PINB.6==0)
_0x33:
	SBIS 0x16,4
	RJMP _0x37
	SBIS 0x16,5
...
; 0000 00E4            PORTB.3=0;
	CBI  0x18,3
; 0000 00E5             if(PINB.4==0 && PINB.5==1 && PINB.6==1)
	SBIC 0x16,4
	RJMP _0x42
	SBIS 0x16,5
	RJMP _0x42
...
; 0000 00EA            }
; 0000 00EB             if(PINB.4==1 && PINB.5==0 && PINB.6==1)
_0x41:
	SBIS 0x16,4
	RJMP _0x45
	SBIC 0x16,5
...
; 0000 00ED             lcd_gotoxy(0,0);
	RCALL SUBOPT_0x0
; 0000 00EE             lcd_putsf("0");
	__POINTW2FN _0x0,20
	RCALL SUBOPT_0x1
; 0000 00EF             delay_ms(50);
; 0000 00F0            }
; 0000 00F1             if(PINB.4==1 && PINB.5==1 && PINB.6==0)
_0x44:
	SBIS 0x16,4
	RJMP _0x48
	SBIS 0x16,5
