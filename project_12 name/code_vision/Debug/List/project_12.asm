...
_char0:
	.DB  0x0,0x0,0x11,0x1F,0xA,0x4,0x0,0x0
_char1:
	.DB  0x1,0x0,0x2,0x4,0x8,0x10,0x0,0x0
_char2:
	.DB  0x4,0xA,0x0,0x17,0x14,0x1C,0x0,0x0
_char3:
	.DB  0x1,0x2,0x4,0x4,0x1C,0x0,0x0,0x0
_char4:
	.DB  0x0,0x0,0x1,0x1,0x1F,0x0,0xA,0x0
_char5:
	.DB  0x0,0x8,0x8,0x8,0x8,0x8,0x0,0x0
_char6:
	.DB  0x0,0x4,0x0,0x11,0x11,0x1F,0x0,0x0
...
;	a -> R16
	...
	ORI  R30,0x40
	MOV  R16,R30
; 0000 0065 for(i=0; i<8; i++)lcd_write_byte(a++,*pc++);
	LDI  R17,LOW(0)
_0x4:
	CPI  R17,8
	BRSH _0x5
...
; 0000 006E DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(15)
	OUT  0x1A,R30
; 0000 006F // State: Bit7=T Bit6=P Bit5=P Bit4=P Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0070 PORTA=(0<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(112)
	OUT  0x1B,R30
; 0000 0071 
...
; 0000 00D4 // RS - PORTA Bit 0
; 0000 00D5 // RD - PORTA Bit 1
; 0000 00D6 // EN - PORTA Bit 2
; 0000 00D7 // D4 - PORTA Bit 4
; 0000 00D8 // D5 - PORTA Bit 5
; 0000 00D9 // D6 - PORTA Bit 6
; 0000 00DA // D7 - PORTA Bit 7
; 0000 00DB // Characters/line: 8
; 0000 00DC lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 00DD define_char(char0,0);
