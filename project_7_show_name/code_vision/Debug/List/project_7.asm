...
_0xB:
	...
	BRGE _0xC
; 0000 009E             {
; 0000 009F              lcd_gotoxy(j,i);
	RCALL SUBOPT_0x0
; 0000 00A0              lcd_putsf("h.p");
...
_0x9:
; 0000 00A4       }
; 0000 00A5       if(PINB.0==1)
_0x6:
	SBIS 0x16,0
	RJMP _0xD
; 0000 00A6       {
; 0000 00A7            for(i=0 ; i<2 ; i=i+1)
	CLR  R4
	CLR  R5
_0xF:
	LDI  R30,LOW(2)
...
_0x12:
	...
	BRGE _0x13
; 0000 00AA             {
; 0000 00AB              lcd_gotoxy(j,i);
	RCALL SUBOPT_0x0
; 0000 00AC              lcd_putsf("h.p");
