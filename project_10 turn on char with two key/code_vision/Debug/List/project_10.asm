...
; 0000 007C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 007D DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(15)
	OUT  0x1A,R30
; 0000 007E // State: Bit7=T Bit6=P Bit5=P Bit4=P Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 007F PORTA=(0<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(112)
	OUT  0x1B,R30
; 0000 0080 
...
; 0000 00EA // Characters/line: 20
; 0000 00EB lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 00EC define_char(char0,0);
...
; 0000 00FD        d=25;
	...
	MOVW R10,R30
; 0000 00FE       }
; 0000 00FF       if(PINB.0==1)
_0xA:
	SBIS 0x16,0
	RJMP _0xB
; 0000 0100       {
; 0000 0101       for(i=0; i<20; i++)
	CLR  R4
	CLR  R5
_0xD:
	LDI  R30,LOW(20)
...
_0x13:
	...
	BRGE _0x14
; 0000 0106         {
; 0000 0107           lcd_gotoxy(i,j);
	RCALL SUBOPT_0x0
; 0000 0108           lcd_putchar(k);
; 0000 0109           delay_ms(d);
; 0000 010A         }
	MOVW R30,R8
	ADIW R30,1
	MOVW R8,R30
...
_0x1D:
	...
	BRGE _0x1E
; 0000 0115         {
; 0000 0116           lcd_gotoxy(i,j);
	RCALL SUBOPT_0x0
; 0000 0117           lcd_putchar(k);
; 0000 0118           delay_ms(d);
; 0000 0119         }
	MOVW R30,R8
	ADIW R30,1
	MOVW R8,R30
