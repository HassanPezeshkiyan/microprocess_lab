...
_0x10:
	...
	BRGE _0x11
; 0000 00FC         {
; 0000 00FD           lcd_gotoxy(i,j);
	RCALL SUBOPT_0x0
; 0000 00FE           lcd_putchar(k);
; 0000 00FF 
; 0000 0100         }
	MOVW R30,R8
	ADIW R30,1
...
_0x19:
	...
	BRGE _0x1A
; 0000 0108         {
; 0000 0109           lcd_gotoxy(i,j);
	RCALL SUBOPT_0x0
; 0000 010A           lcd_putchar(k);
