...
_0xC:
; 0000 009B       }
; 0000 009C       if(PINB.1==0){delay_ms(50);}
_0xA:
	SBIC 0x16,1
	RJMP _0xD
	LDI  R26,LOW(50)
	LDI  R27,0
	CALL _delay_ms
; 0000 009D       if(PINB.1==1){delay_ms(100);}
_0xD:
	SBIS 0x16,1
	RJMP _0xE
	LDI  R26,LOW(100)
