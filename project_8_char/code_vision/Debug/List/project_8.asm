...
_0x0:
	.DB  0x77,0x65,0x65,0x6B,0x20,0x73,0x74,0x61
	.DB  0x72,0x74,0x20,0x64,0x61,0x79,0x20,0x3A
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
;void define_char(byte flash *p , byte char_code){
; 0000 0021 void define_char(byte flash *p , byte char_code){

	.CSEG
_define_char:
; .FSTART _define_char
; 0000 0022  byte i, a;
; 0000 0023  a = (char_code<<3)|0x40;
	ST   -Y,R26
	ST   -Y,R17
	ST   -Y,R16
;	*p -> Y+3
...
;	a -> R16
	...
	ORI  R30,0x40
	MOV  R16,R30
; 0000 0024  for(i=0; i<8; i++)lcd_write_byte(a++, *p++);
	LDI  R17,LOW(0)
_0x4:
	CPI  R17,8
	BRSH _0x5
...
; 0000 002C // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 002D DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(15)
	OUT  0x1A,R30
; 0000 002E // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 002F PORTA=(0<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(112)
	OUT  0x1B,R30
; 0000 0030 
; 0000 0031 // Port B initialization
; 0000 0032 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0033 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(15)
	OUT  0x17,R30
; 0000 0034 // State: Bit7=T Bit6=P Bit5=P Bit4=P Bit3=0 Bit2=0 Bit1=0 Bit0=0
; 0000 0035 PORTB=(0<<PORTB7) | (1<<PORTB6) | (1<<PORTB5) | (1<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(112)
	OUT  0x18,R30
; 0000 0036 
...
; 0000 0095 // EN - PORTA Bit 2
; 0000 0096 // D4 - PORTA Bit 4
; 0000 0097 // D5 - PORTA Bit 5
; 0000 0098 // D6 - PORTA Bit 6
; 0000 0099 // D7 - PORTA Bit 7
; 0000 009A // Characters/line: 20
; 0000 009B lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 009C define_char(char0,0);
...
; 0000 009F lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00A0 lcd_putsf("week start day :");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00A1 lcd_putchar(2);
	LDI  R26,LOW(2)
	RCALL _lcd_putchar
; 0000 00A2 lcd_putchar(1);
	LDI  R26,LOW(1)
	RCALL _lcd_putchar
; 0000 00A3 lcd_putchar(0);
	LDI  R26,LOW(0)
	RCALL _lcd_putchar
; 0000 00A4 while (1)
_0x6:
