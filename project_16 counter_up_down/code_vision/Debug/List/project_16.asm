...
; 0000 002D    if (i>0)
	...
	BRSH _0x3
; 0000 002E    {
; 0000 002F    PORTA=number[--i];
	DEC  R5
	RCALL SUBOPT_0x0
; 0000 0030    }
; 0000 0031    while(PIND.2==0){}
_0x3:
_0x4:
	SBIS 0x10,2
	RJMP _0x4
...
; 0000 0039     if(i<9)
	...
	BRSH _0x7
; 0000 003A     {
; 0000 003B     PORTA=number[++i];
	INC  R5
	RCALL SUBOPT_0x0
; 0000 003C     }
; 0000 003D     while(PIND.3==0){}
_0x7:
_0x8:
	SBIS 0x10,3
	RJMP _0x8
...
; 0000 008B // INT0: On
; 0000 008C // INT0 Mode: Falling Edge
; 0000 008D // INT1: On
; 0000 008E // INT1 Mode: Falling Edge
; 0000 008F // INT2: Off
; 0000 0090 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
...
; 0000 0092 MCUCSR=(0<<ISC2);
	LDI  R30,LOW(0)
	OUT  0x34,R30
; 0000 0093 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0094 
...
SUBOPT_0x0:
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_number*2)
	SBCI R31,HIGH(-_number*2)
	LPM  R0,Z
	OUT  0x1B,R0
	RET
